      ...
      <ThemeProvider theme={defaultTheme}>
        <Grid container component="main" sx={{ height: '100vh', display: 'flex' }}>
          ...
          <Grid
            ...
            md={7}
            sx={{
              backgroundImage: 'url(https://i.ytimg.com/vi/VFsmuRPClr4/hq720.jpg?sqp=-oaymwEhCK4FEIIDSFryq4qpAxMIARUAAAAAGAElAADIQj0AgKJD&rs=AOn4CLAhXd7WIcy3TIl79ULUYsUdsVTXng)',
